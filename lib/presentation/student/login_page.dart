...
class _LoginPageState extends State<LoginPage> {
  ...
  void _login() {
    ...
    if (phoneNumber.length == 10) {
      ...
      if (password == '2626') {
        // Navigate to main navigation page using named route
        Navigator.pushReplacementNamed(
          context,
          Routes.studentMainNavigation,
        );
      } else {
                    ...
                    Row(
                      ...
                      children: List.generate(10, (index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: _phoneFocusNodes[index].hasFocus ? const Color(0xFF8E24AA) : const Color(0xFFE9ECEF),
                              width: 2,
                            ),
                    ...
                    Row(
                      ...
                      children: List.generate(4, (index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: _passwordFocusNodes[index].hasFocus ? const Color(0xFF8E24AA) : const Color(0xFFE9ECEF),
                              width: 2,
                            ),
